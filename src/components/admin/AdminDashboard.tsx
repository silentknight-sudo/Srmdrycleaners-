    ...
    <div className="max-w-[1600px] mx-auto px-6 py-12 space-y-12">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8">
        <div className="space-y-2">
          ...
          <p className="text-gray-500 font-medium">Global fleet management and garment logistics overview</p>
        </div>
        <div className="flex items-center gap-4">
           <Button variant="outline" onClick={() => seedServices(PRICING_DATA)} className="rounded-2xl border-2 h-12 font-bold">
              Sync Catalog
           </Button>
           <Button className="rounded-2xl bg-gray-900 h-12 px-8 font-bold">
            ...
            <Card className="rounded-[40px] border-none shadow-[0_8px_40px_rgba(0,0,0,0.04)] bg-srm-blue text-white p-8">
               <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                     ...
                     <p className="text-blue-100 text-sm font-medium">Greater Noida branch is reporting high laundry volume. Suggested pickup delay: +2 hours.</p>
                  </div>
                  <Button className="w-full bg-white text-srm-blue font-black rounded-2xl h-12">Global Broadcast</Button>
               </div>
            </Card>
